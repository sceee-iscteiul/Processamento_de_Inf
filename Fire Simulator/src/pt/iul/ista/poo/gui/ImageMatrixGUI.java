...
//		info.setPreferredSize(new Dimension(N_SQUARES_WIDTH * SQUARE_SIZE, LABEL_HEIGHT));
	...
	synchronized void waitForClick() throws InterruptedException {
		...
		Point2D windowCoordinate = new Point2D(lastMouseCoordinate.getX()/SQUARE_SIZE, lastMouseCoordinate.getY()/SQUARE_SIZE);
		setChanged();
		notifyObservers(windowCoordinate/*lastMouseCoordinate*/);
		mouseClicked = false;
	}
